<?php
	...
	$mails = 'm2.design@mail.ru';
	$subject = "Заявка с сайта ,,МАМА, Я ПЛЫВУ,,";
	...
	<tr>
		<td width='200' style='padding:10px; background:#ececec;'>Откуда заявка:</td>
		<td width='400' style='padding:10px;'>$otkuda</td>
	</tr>
	<tr>
	...
	<tr>
		<td width='200' style='padding:10px; background:#ececec;'>mail:</td>
		<td width='400' style='padding:10px;'>$email</td>
	</tr>
	<tr>
		<td width='200' style='padding:10px; background:#ececec;'>message:</td>
		<td width='400' style='padding:10px;'>$message</td>
	</tr>
	<tr>
